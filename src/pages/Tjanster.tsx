      ...
      <section className="relative bg-hero pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: "0.1s" }}>Vi erbjuder ILCA- och Opti-coaching med passion och kunskap från vår egen elitsatsning. Läs mer nedan och tveka inte att kontakta oss.
